    ...
    return Scaffold(
      body: DefaultTabController(
        ...
        child: NestedScrollView(
            ...
            return <Widget>[
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                    centerTitle: true,
                    title: Text("Home Crime",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 16.0,
                        )),
                    background: Image.network(
                      "https://image.shutterstock.com/image-illustration/home-invasion-crime-scene-wrecked-260nw-258423893.jpg",
                      fit: BoxFit.cover,
                    )),
              ),
          ...
          body: // tab page,
              TabBarView(
            children: [Infoscreen(), ReportScreen()],
          ),
        ),
      ),
    );
